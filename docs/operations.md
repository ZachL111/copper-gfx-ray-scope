...
`copper-gfx-ray-scope` is centered on graphics work in Dart. The technical target is: Design a Dart verification harness for ray systems, covering protocol validation, framed sample traffic, and failure-oriented tests.
...
The score is deterministic. The current threshold is 171. Risk has a penalty of 6, latency has a penalty of 2, and weight contributes a bonus of 6.
