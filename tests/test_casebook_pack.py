"""Regression checks for the copper-gfx-ray-scope casebook."""
...
from casebook.harness import assert_expected, copper_gfx_ray_scope_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(copper_gfx_ray_scope_summary(), assert_expected())
