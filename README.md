...
copper-gfx-ray-scope is a Dart project for graphics. It focuses on this technical goal: Design a Dart verification harness for ray systems, covering protocol validation, framed sample traffic, and failure-oriented tests.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 171, risk penalty 6, latency penalty 2, and weight bonus 6. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
